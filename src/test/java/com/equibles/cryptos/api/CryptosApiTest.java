...
/**
 * API tests for CryptosApi
 */
@Ignore
public class CryptosApiTest {

    private final CryptosApi api = new CryptosApi();
    ...
    public void listTest() throws Exception {
        ...
        CryptoCurrencyProfilesResponse response = api.list(page, pageSize);
    ...
    public void profileTest() throws Exception {
        String ticker = null;
        CryptoCurrencyProfileResponse response = api.profile(ticker);
