...
public class PricesApiTest {
    ...
    public void endOfDayTest() throws Exception {
        ...
        PricesResponse response = api.endOfDay(ticker, startTime, endTime, page, pageSize);
     ...
     */
    @Test
    public void intradayTest() throws Exception {
        String ticker = null;
        OffsetDateTime startTime = null;
        OffsetDateTime endTime = null;
        Integer page = null;
        Integer pageSize = null;
        PricesResponse response = api.intraday(ticker, startTime, endTime, page, pageSize);
